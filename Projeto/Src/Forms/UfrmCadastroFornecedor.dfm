inherited frmCadastroFornecedor: TfrmCadastroFornecedor
  ...
  object cxGroupBox10: TcxGroupBox [8]
    Left = 499
    Top = 147
    Caption = 'UF'
    TabOrder = 11
  ...
  object cxGroupBox7: TcxGroupBox [9]
    Left = 304
    Top = 100
  ...
  object cxGroupBox6: TcxGroupBox [11]
    Left = 499
    Top = 52
    Anchors = [akLeft, akTop, akRight]
    ...
    Height = 44
    Width = 142
    object edtLimiteDeCredito: TcxDBMaskEdit
      Left = 10
      Top = 16
      Anchors = [akLeft, akTop, akRight]
  ...
  object cxGroupBox1: TcxGroupBox [12]
    Left = 10
    Top = 4
    Caption = 'C'#243'digo '
    TabOrder = 0
