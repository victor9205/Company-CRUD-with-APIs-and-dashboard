inherited frmCadastroDependentes: TfrmCadastroDependentes
  ...
  object gbEndereco: TcxGroupBox [1]
    Left = 10
    Top = 148
  ...
  object dataNascimento: TcxGroupBox [2]
    Left = 149
    Top = 196
    Anchors = [akLeft, akTop, akRight]
  ...
  object codigoEmpregado: TcxGroupBox [3]
    Left = 10
    Top = 4
    Caption = 'C'#243'digo do Empregado'
    TabOrder = 0
    Height = 44
    Width = 129
    object EdtCodigo: TcxDBTextEdit
      Left = 10
      Top = 16
      DataBinding.DataField = 'CODIGOEMPREGADO'
      DataBinding.DataSource = dsCadastro
      TabOrder = 0
      Width = 109
    end
  end
  object nomeDependente: TcxGroupBox [4]
    Tag = 1
    Left = 149
    Top = 4
  ...
  object nomePai: TcxGroupBox [6]
    ...
    Height = 44
    Width = 183
    object EditNomePai: TcxDBTextEdit
      Left = 10
      Top = 16
      Anchors = [akLeft, akTop, akRight]
  ...
  object gbTelefone: TcxGroupBox [8]
    Left = 10
    Top = 196
    Caption = 'Telefone'
    TabOrder = 8
  ...
  object cpf: TcxGroupBox [10]
    ...
    object EditCPF: TcxDBMaskEdit
      ...
      DataBinding.DataSource = dsCadastro
      Properties.EditMask = '000\.000\.000\-99'
      TabOrder = 0
      Width = 95
    end
  end
  object cxGroupBox8: TcxGroupBox [11]
    Left = 160
    Top = 52
    Caption = 'CEP'
    TabOrder = 3
  ...
  object nomeMae: TcxGroupBox [12]
    ...
    Height = 44
    Width = 182
    object EditNomeMae: TcxDBTextEdit
      Left = 10
      Top = 16
      Anchors = [akLeft, akTop, akRight]
